...
namespace BasicEyetrackingSample
{
    public partial class MainForm : Form
    {
        ...
        private void _connectedTracker_GazeDataReceived(object sender, GazeDataEventArgs e)
        {
            ...
            Console.WriteLine("left gaze point 2d {0:F20}", e.GazeDataItem.LeftGazePoint2D);
            Console.WriteLine("right gaze point 2d {0:F20}", e.GazeDataItem.RightGazePoint2D);
            Console.WriteLine("left gaze point 3d {0:F20}", e.GazeDataItem.LeftGazePoint3D);
            Console.WriteLine("right gaze point 3d {0:F20}", e.GazeDataItem.RightGazePoint3D);
            Console.WriteLine("left eye position 3d {0:F20}", e.GazeDataItem.LeftEyePosition3D);
            Console.WriteLine("right eye position 3d {0:F20}", e.GazeDataItem.RightEyePosition3D);
            Console.WriteLine("left pupil diameter {0:F20}", e.GazeDataItem.LeftPupilDiameter);
            Console.WriteLine("right pupil diameter {0:F20}", e.GazeDataItem.RightPupilDiameter);
            Console.WriteLine("left eye validity {0}", e.GazeDataItem.LeftValidity);
            Console.WriteLine("right eye validity {0}", e.GazeDataItem.RightValidity);
            Console.WriteLine("Timestamp: {0:F20}", e.GazeDataItem.Timestamp);
